...
const logos = [
  { link: 'http://meity.gov.in', alt: 'Meity Logo' },
  { link: 'https://mygov.in/', alt: 'MyGov Logo' },
  { link: 'https://www.nic.in/', alt: 'NIC Logo' },
  { link: 'https://www.india.gov.in/', alt: 'India Gov Logo' },
  { link: 'https://www.digitalindia.gov.in/', alt: 'Digital India Logo' },
];
